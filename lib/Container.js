...
var _KoaAuth = require('./middlewares/KoaAuth');

var _KoaAuth2 = _interopRequireDefault(_KoaAuth);
...
var Container = function (_Context) {
    ...
    function Container(config) {
        ...
        var oauthServer = new _KoaOAuthServer2.default({
            debug: false,
            model: new _OAuth2.default(models)
        });

        _this.register('models', models).register('auth', new _KoaAuth2.default(oauthServer)).register('default.client', _this.config.client);
        return _this;
    }
