...
var KoaOAuthServer = function KoaOAuthServer(options) {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _context.prev = 1;
                            _context.next = 4;
                            return _this.delegate.authenticate(request);
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            _context2.prev = 2;
                            _context2.next = 5;
                            return _this.delegate.authorize(request, response);
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            _context3.prev = 2;
                            _context3.next = 5;
                            return _this.delegate.token(request, response);
    ...
    this.delegate = new _oauth2Server2.default(options);
